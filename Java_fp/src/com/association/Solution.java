...
import com.association.UserCredentials;
import com.association.UserProfile;
...
public class Solution {
	...
	public static void main(String[] args) {
		...
		UserCredentials steve = new UserCredentials();
		steve.setUsername("steve");
		steve.setPassword("jobs");
		steve.setStatus(0);
		
		UserCredentials guido = new UserCredentials();
